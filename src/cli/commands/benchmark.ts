    ...
    for (const descriptor of descriptors) {
      ...
      for (const configuration of requested) {
        ...
        results.push({
          ...
          falsePositiveRateCi: falsePositiveRateCi(predictions),
          overallRecall: overallRecall(predictions).value,
          overallRecallCi: overallRecall(predictions).ci,
      ...
      corpora.push({
        corpus: {
          ...
          controlSet: descriptor.controlSet,
        },
